...
const PICKS: PickSet[] = [
  ...
  },
  {
    ...
    eventLine: '1-rep-max deadlift. Competition-verified where available (2023 Rogue).',
    note: 'Real 2023 Rogue Invitational max deadlift where available, else reported PR. A strength read, not a result prediction.',
    men: [
    ...
    women: [
      { name: 'Alex Gazan', value: '425', why: '2023 Rogue max-deadlift WINNER, a PR.' },
      { name: 'Madeline Sturt', value: '408', why: 'Reported PR.' },
      { name: 'Aimee Cringle', value: '408', why: 'Reported PR.' },
      { name: 'Mirjam von Rohr', value: '405', why: 'Estimate.' },
      { name: 'Hannah Black', value: '400', why: 'Reported PR.' },
    ],
  },
  {
    id: 'cf-total',
    ...
    women: [
      ...
      { name: 'Mirjam von Rohr', value: '900', why: 'Record-squat winner (360) plus a big pull.' },
  ...
  },
  {
    ...
    men: [
      { name: 'Jeffrey Adler', value: '81', why: '72kg with a 74 engine. Best power-to-weight up top, exactly what a run rewards.' },
      { name: 'Justin Medeiros', value: '79', why: '79 oxidative, 78 monostructural on a runnable 88kg frame.' },
      { name: 'Ricky Garard', value: '78', why: '77 monostructural, 75 engine. Steady over distance at 85kg.' },
      { name: 'Roman Khrennikov', value: '77', why: 'Biggest engine in the field (81 mono), but 97kg is the tax a 7.2km run collects.' },
      { name: 'Patrick Vellner', value: '72', why: '75 oxidative and monostructural. Grinds the back half.' },
    ],
    women: [
...
const CAROUSELS: Carousel[] = [
  ...
  },
  {
    ...
    caption:
      "🏋️ EVENTS 3-5 = THE CROSSFIT TOTAL. The Games bring back the Total: 1-rep-max back squat (E3), shoulder press (E4), deadlift (E5), each scored as its own 50-point event. 150 points on the line.\n\nWe went to the tape, real competition maxes from the 2025 Games back squat, the 2023 Rogue deadlift and the 2020 Games press, so here is a leaderboard for every lift plus the overall Total. Estimates are labeled. A strength read, not a result prediction. Full breakdown at the link in bio.\n\nEvent source: the official CrossFit Games workout page.",
    slides: [
      ...
      { type: 'point', num: 4, kicker: 'Event 5 - Deadlift', headline: 'GAZAN\n425 LB', body: 'From the 2023 Rogue max deadlift: Vellner and Magda 595, Medeiros 600, Mathew 605. Women: Gazan won Rogue at 425, Sturt and Cringle at 408.', source: '2023 Rogue + reported' },
      { type: 'point', num: 5, kicker: 'Overall Total - Top 3', headline: 'MATHEW.\nGAZAN.', body: 'Squat + press + deadlift: Men, Mathew near 1355, Mertens 1290, Medeiros 1287. Women, Gazan near 912, von Rohr 900, Black 895. Gazan is the only woman elite in all three.', source: 'Persistence Athletics model' },
