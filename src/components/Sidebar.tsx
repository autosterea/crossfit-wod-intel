    ...
    <>
      ...
      `}>
        ...
        >
          <div className="flex items-center justify-between gap-2">
            <div className="min-w-0">
              <div className="text-[11px] font-bold text-[#91C640] truncate">CrossFit Now</div>
              <div className="text-[8px] text-[var(--text-muted)] uppercase tracking-wider">Daily Games news + results →</div>
            </div>
            <span className="shrink-0 text-[8px] font-bold px-1.5 py-0.5 rounded bg-[#91C640]/20 text-[#91C640] group-hover:bg-[#91C640]/30">NEW</span>
          </div>
        </a>
