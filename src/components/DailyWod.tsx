        ...
        <>
          ...
          {!looksLikeWorkout && workout.isLive && (
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg px-4 py-3 flex items-start gap-3">
              ...
              <div>
                <p className="text-xs text-amber-300 font-medium">Article / Rest Day</p>
                <p className="text-[11px] text-amber-200/70 mt-0.5">crossfit.com posted a journal article or rest day today instead of a workout. The content below is what they published.</p>
              </div>
            </div>
          )}
